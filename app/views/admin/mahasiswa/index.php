...
<div class="app">
    <aside class="sidebar">
        ...
        <a href="?action=admin&sub=mahasiswa" class="active">Mahasiswa</a>
    ...
    <main class="main">
        <div class="header">
            ...
            <a href="?action=admin&sub=mahasiswa-create" class="btn-primary">+ Tambah Mahasiswa</a>
        </div>
        <table class="table-custom">
            <thead><tr><th>NIM</th><th>Nama</th><th>Prodi</th><th>Angkatan</th><th>Email</th><th>Aksi</th></tr></thead>
            <tbody>
            <?php if (isset($data) && count($data) > 0): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?action=admin&sub=mahasiswa-edit&id=<?= $m['id'] ?>" class="btn-edit">Edit</a>
                        <a href="?action=admin&sub=mahasiswa-delete&id=<?= $m['id'] ?>" class="btn-delete" onclick="return confirm('Hapus mahasiswa ini?')">Hapus</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr><td colspan="6" style="text-align:center;color:#94a3b8;padding:20px 0;">Belum ada data mahasiswa.</td></tr>
            <?php endif; ?>
            </tbody>
        </table>
    </main>
