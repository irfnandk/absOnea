...
<div class="app">
    <aside class="sidebar">
        ...
        <a href="?action=admin&sub=dosen" class="active">Dosen</a>
    ...
    <main class="main">
        <div class="header">
            <h1>Data Dosen</h1>
            <a href="?action=admin&sub=dosen-create" class="btn-primary">+ Tambah Dosen</a>
        </div>
        <table class="table-custom">
            <thead><tr><th>NIDN</th><th>Nama</th><th>Email</th><th>Aksi</th></tr></thead>
            <tbody>
            <?php if (isset($data) && count($data) > 0): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?action=admin&sub=dosen-edit&id=<?= $d['id'] ?>" class="btn-edit">Edit</a>
                        <a href="?action=admin&sub=dosen-delete&id=<?= $d['id'] ?>" class="btn-delete" onclick="return confirm('Hapus dosen ini?')">Hapus</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr><td colspan="4" style="text-align:center;color:#94a3b8;padding:20px 0;">Belum ada data dosen.</td></tr>
            <?php endif; ?>
            </tbody>
        </table>
    </main>
