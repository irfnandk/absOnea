...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .filter-form .btn-filter { background:#2563eb; border:none; border-radius:40px; padding:8px 24px; color:#fff; font-weight:500; cursor:pointer; }
        .filter-form .btn-filter:hover { background:#1d4ed8; }
        .btn-export { background:#16a34a; border:none; border-radius:40px; padding:8px 24px; color:#fff; font-weight:500; text-decoration:none; display:inline-block; }
...
<div class="app">
    <aside class="sidebar">
        ...
        <a href="?action=admin&sub=laporan" class="active">Laporan</a>
    ...
    <main class="main">
        <div class="header">
            ...
            <div>
                <a href="?action=admin&sub=export-excel&<?= http_build_query($_GET) ?>" class="btn-export">Export Excel</a>
            </div>
        </div>
        ...
        <form method="GET" class="filter-form">
            ...
            <div class="form-group">
                ...
                <select name="dosen_id">
                    ...
                    <option value="<?= $d['id'] ?>" <?= (isset($_GET['dosen_id']) && $_GET['dosen_id'] == $d['id']) ? 'selected' : '' ?>><?= $d['nama'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="form-group">
